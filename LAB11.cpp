...
int main(){
	...
	list = addStudent(list,"Hung", 23,8,1995,7,5,8);
	list = addStudent(list,"Thi", 30,4,1998,9,6,10);
	list = addStudent(list,"Anh", 26,3,1997,3,8,5);
	list = addStudent(list,"Thu", 10,6,1995,9,6,10);
	list = addStudent(list,"Hong", 17,8,1995,3,5,7);
	...
	// Kiem tra neu Hung va Hong ton tai
